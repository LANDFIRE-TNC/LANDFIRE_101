...
::: logo-row
<img src="images/usda-logo-color.png" alt="USDA logo" style="height: 70px; margin: 0 20px;"/> <img src="images/green usfas.png" alt="US Forest Service logo" style="height: 80px; margin: 0 20px;"/> <img src="images/DOI.png" alt="US Department of the Interior logo" style="height: 80px; margin: 0 20px;"/> <img src="images/LANDFIRE.png" alt="LANDFIRE program logo" style="height: 83px; margin: 0 10px;"/>
:::

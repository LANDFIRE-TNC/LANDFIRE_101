...
3.  On many of the product pages, you will find a section on Key Attributes, which provides more information on the attributes of that specific dataset. You can also download a .csv file attribute table for the most recent LANDFIRE dataset there (see 'With the .csv file for each layer' section below).

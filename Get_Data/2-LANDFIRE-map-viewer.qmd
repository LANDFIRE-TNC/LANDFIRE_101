...
5.  Once all desired datasets are selected, scroll down to enter your e-mail address. Soon after clicking the Download button you will receive an email announcing that your data is ready for download. Follow the instructions in that email.

After you click the Download button on the LFMV you will eventually receive an email with instructions. The zipped data will likely land in your Downloads directory. Then you can extract the data to a useful location and begin using LANDFIRE data in your projects and analyses.

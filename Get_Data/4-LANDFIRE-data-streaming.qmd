...
- **What is LFPS?**
    - LFPS is a service that provides access to a wide range of landscape data products through a REST API. This allows you to request and download LANDFIRE products through an API using HTTPS requests. It can also be used within standalone applications to request data from LANDFIRE.
...
For more detailed instructions and examples, please refer to the full [LANDFIRE Products Service User Guide](https://lfps.usgs.gov/LFProductsServiceUserGuide.pdf).
...
::: callout-note
You cannot change symbology or do analysis with the WMS. You can simply view a simplified form of the data and display it in your maps. Often WCS and WMS are combined to get the correct display and access the data.
:::
